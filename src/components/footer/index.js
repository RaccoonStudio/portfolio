  ...
  <footer className={Styles.footer} id={componentId}>
    <div className={Styles.footer__container}>
      <div className={Styles.footer__branding}>
        <img className={Styles.footer__logo} src={raccoonLogo} alt={siteTitle} />
      ...
      <div className={Styles.footer__storyContainer}>
        ...
        <p className={Styles.footer__story}>
          I love <em>rooibos tea</em>, <em>oat-milk latte</em>, <em lang="sv">kanelbullar</em> and discussing{' '}
          <em>how to make the Web a better place</em>.
        </p>
        <p className={Styles.footer__story}>
          So, whether you are <em>a conference or meetup organiser</em>, <em>a project maker</em> or just interested by
          my profile, <em>let&apos;s have a chat!</em>
        </p>
        <p className={Styles.footer__contact}>
          <a className={Styles.footer__email} href="mailto:hello@raccoon.studio">
